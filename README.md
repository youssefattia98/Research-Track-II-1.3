...
This repo shows a statistical analysis done between [A studnet repo](https://github.com/youssefattia98/Research-Track-I-1) and [the professor repo](https://github.com/CarmineD8/python_simulator/tree/rt2).
